          ...
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-medium p-8 md:p-12">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-sm text-psycho-gray-500 mb-6">
              ...
              <div>
                ...
                <h3 className="font-serif text-xl font-semibold mb-2 text-psycho-gray-800">
                  Interpretation
                </h3>
                <p className="text-psycho-gray-600">
                ...
                <h3 className="font-serif text-xl font-semibold mb-2 mt-6 text-psycho-gray-800">
                  Definitions
                </h3>
                <p className="text-psycho-gray-600">
                  For the purposes of this Privacy Policy:
                </p>
                <ul className="list-disc list-inside mt-2 text-psycho-gray-600 space-y-2">
                  <li>
                  ...
                  <li>
                    ...
                    Liam Graham Psychometry, 279 Cape Road Metropolitan Office
                    Park, Block A Greenacres, Newton Park 6055.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to Liam Graham Psychometry,
                    accessible from
                    <a
                      href="https://liamgrahampsychometry.co.za"
                      className="text-psycho-blue-600 hover:text-psycho-blue-800 ml-1"
                    >
                      https://liamgrahampsychometry.co.za
                    </a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <h4 className="font-serif text-lg font-medium mb-2 mt-4 text-psycho-gray-800">
                  Personal Data
                </h4>
                <p className="text-psycho-gray-600">
                ...
                <ul className="mt-2 text-psycho-gray-600 space-y-4">
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside mt-2 text-psycho-gray-600 space-y-1">
                  <li>
              ...
              <div>
                ...
                <h4 className="font-serif text-lg font-medium mb-2 text-psycho-gray-800">
              ...
              <div>
                ...
                <p className="text-psycho-gray-600 mt-2">
                  By email: lgrahampsychometry@outlook.com
                </p>
              </div>
            </div>
          </div>
